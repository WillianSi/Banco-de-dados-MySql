...
-- Copiando dados para a tabela supermercado.cargo: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela supermercado.cliente: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela supermercado.fornecedor: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela supermercado.funcionario: ~0 rows (aproximadamente)
...
INSERT INTO `funcionario` (`idFuncionario`, `nome`, `dataNascimento`, `cpf`, `telefone`, `email`, `endereco`, `bairro`, `cidade`, `cep`, `uf`, `CARGO_idCargo`) VALUES
	(1, 'Zacarias de Sousa', '2000-08-29', '012.142.881-89', '(35) 92670223', 'zackary.barton@hotmail.com', '8654 Ryan Keys Suite 564', 'Collierville', 'Machado', '37750-000', 'MG', 1),
	(2, 'Jaqueline Cardoso', '1990-04-22', '161.147.173-76', '(35) 95501-1624', 'jaquelin_mosciski@gmail.com', '78261 Cassin Cliff Apt. 087', 'Grand Island', 'Machado', '37750-000', 'MG', 2);
...
-- Copiando dados para a tabela supermercado.itens_venda: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela supermercado.marca: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela supermercado.produto: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela supermercado.produto_fornecedor: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela supermercado.venda: ~0 rows (aproximadamente)
